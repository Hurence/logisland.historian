...
public class DatasourcesApiController implements DatasourcesApi {
    ...
    public ResponseEntity<Datasource> addDatasourceWithId(@ApiParam(value = "Datasource resource to add" ,required=true )  @Valid @RequestBody Datasource body,@ApiParam(value = "datasourceId to",required=true) @PathVariable("datasourceId") String datasourceId) {
        ...
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<Datasource>(objectMapper.readValue("{  \"clsid\" : \"clsid\",  \"password\" : \"password\",  \"domain\" : \"domain\",  \"host\" : \"host\",  \"description\" : \"description\",  \"id\" : \"id\",  \"user\" : \"user\"}", Datasource.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
    ...
    public ResponseEntity<List<Datasource>> getAllDatasources() {
        ...
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<List<Datasource>>(objectMapper.readValue("[ {  \"clsid\" : \"clsid\",  \"password\" : \"password\",  \"domain\" : \"domain\",  \"host\" : \"host\",  \"description\" : \"description\",  \"id\" : \"id\",  \"user\" : \"user\"}, {  \"clsid\" : \"clsid\",  \"password\" : \"password\",  \"domain\" : \"domain\",  \"host\" : \"host\",  \"description\" : \"description\",  \"id\" : \"id\",  \"user\" : \"user\"} ]", List.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
                log.error("Couldn't serialize response for content type application/json", e);
    ...
    public ResponseEntity<List<Tag>> getAllDatasourcesTags() {
        ...
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<List<Tag>>(objectMapper.readValue("[ {  \"server\" : \"server\",  \"last_polling_date\" : 1,  \"tag_name\" : \"tag_name\",  \"update_rate\" : 5,  \"min_numeric_value\" : 5.63737665663332876420099637471139430999755859375,  \"description\" : \"description\",  \"creation_date\" : 0,  \"last_quality\" : 9,  \"labels\" : [ \"labels\", \"labels\" ],  \"last_numeric_value\" : 7.061401241503109,  \"domain\" : \"domain\",  \"data_type\" : \"float\",  \"last_modification_date\" : 6,  \"max_numeric_value\" : 2.3021358869347655,  \"id\" : \"mySweetUniqueId\",  \"text\" : [ \"text\", \"text\" ],  \"last_base64_value\" : \"last_base64_value\",  \"group\" : \"group\"}, {  \"server\" : \"server\",  \"last_polling_date\" : 1,  \"tag_name\" : \"tag_name\",  \"update_rate\" : 5,  \"min_numeric_value\" : 5.63737665663332876420099637471139430999755859375,  \"description\" : \"description\",  \"creation_date\" : 0,  \"last_quality\" : 9,  \"labels\" : [ \"labels\", \"labels\" ],  \"last_numeric_value\" : 7.061401241503109,  \"domain\" : \"domain\",  \"data_type\" : \"float\",  \"last_modification_date\" : 6,  \"max_numeric_value\" : 2.3021358869347655,  \"id\" : \"mySweetUniqueId\",  \"text\" : [ \"text\", \"text\" ],  \"last_base64_value\" : \"last_base64_value\",  \"group\" : \"group\"} ]", List.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
                log.error("Couldn't serialize response for content type application/json", e);
