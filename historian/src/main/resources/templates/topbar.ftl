...
<div class='page-topbar '>
  <div class='logo-area'>
<a href="plik.html"><img src="/images/logo.png" id="logo"/></a>
  </div>

<div class="pull-left">

  <h3 class="title"></span>LOGISLAND DATA HIST<i class="fa fa-clock-o"></i>RIAN</h3> </div>
