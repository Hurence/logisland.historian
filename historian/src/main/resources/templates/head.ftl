<head>
    <title>Logisland Data Historian</title>
    ...
    <link href="/plugins/jstree/themes/default/style.css" rel="stylesheet" type="text/css" media="screen"/>
    ...
    <link href="/plugins/daterangepicker/daterangepicker.css" rel="stylesheet" type="text/css" media="screen"/>
    <link href="/plugins/uikit/css/uikit.min.css" rel="stylesheet" type="text/css" media="screen"/>
    <link href="/plugins/uikit/css/components/nestable.min.css" rel="stylesheet" type="text/css" media="screen"/>

    <!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - END -->


    <!-- CORE CSS TEMPLATE - START -->
    <link href="/css/style-logisland-historian.css" rel="stylesheet" type="text/css"/>
