...
if __name__ == "__main__":
    ...
    # logger.setLevel(logging.DEBUG)# python server-datavalue-history.py
    #logger = logging.getLogger("opcua.internal_server")# python server-datavalue-history.py
    # logger.setLevel(logging.DEBUG)# python server-datavalue-history.py
    #logger = logging.getLogger("opcua.binary_server_asyn# python server-datavalue-history.pycio")
    ...
    server.set_endpoint("opc.tcp://0.0.0.0:4840/hurence/server/")
    server.set_server_name("Hurence Example Server")
    # set all possible endpoint policies for clients to connect through
    server.set_security_policy([ua.SecurityPolicyType.NoSecurity])

    # setup our own namespace
    uri = "http://historian.hurence.com"
