...
public interface DatasourcesApi {
    ...
    @ApiOperation(value = "Browse tags from a given datasource", nickname = "browseTagsFromDatasource", notes = "Browse tags through this datasource", response = Tag.class, responseContainer = "List", tags = {"tag", "datasource",})
    @ApiResponses(value = {
